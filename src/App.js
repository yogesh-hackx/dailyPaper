...
class App extends React.Component {
    ...
    checkNoOfPages = async () => {
        ...
        for(let i=10; i<20; i++) {
            try {
                let exists = await imageExists(`https://epaperwmimg.amarujala.com/2024/${this.validPageNoInStr(this.state.month)}/${this.validPageNoInStr(this.state.day)}/al/${this.validPageNoInStr(i)}/hdimage.jpg`)
                if (!exists)
                    break;
                this.setState({
                    totalPages: i
            ...
            <div>
                <div className="content">
                    ...
                    <div className="paper-image">
                        <img
                            ref={this.scrollRef}
                            src={`https://epaperwmimg.amarujala.com/2024/${this.state.month}/${this.state.day}/al/${this.state.currPage}/hdimage.jpg`}
                            alt="newsimage"
